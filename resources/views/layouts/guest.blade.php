...
<head>
    ...
    @if (File::exists(public_path('user-uploads/favicons/restaurant/' . $restaurant->hash . '/apple-touch-icon.png')))
    <link rel="apple-touch-icon" sizes="180x180"
            href="{{ asset('user-uploads/favicons/restaurant/' . $restaurant->hash . '/apple-touch-icon.png') }}">
    @endif

    @if (File::exists(public_path('user-uploads/favicons/restaurant/' . $restaurant->hash . '/android-chrome-192x192.png')))
    <link rel="icon" type="image/png" sizes="192x192"
            href="{{ asset('user-uploads/favicons/restaurant/' . $restaurant->hash . '/android-chrome-192x192.png') }}">
    @endif

    @if (File::exists(public_path('user-uploads/favicons/restaurant/' . $restaurant->hash . '/android-chrome-512x512.png')))
    <link rel="icon" type="image/png" sizes="512x512"
            href="{{ asset('user-uploads/favicons/restaurant/' . $restaurant->hash . '/android-chrome-512x512.png') }}">
    @endif

    @if (File::exists(public_path('user-uploads/favicons/restaurant/' . $restaurant->hash . '/favicon-16x16.png')))
    <link rel="icon" type="image/png" sizes="16x16"
            href="{{ asset('user-uploads/favicons/restaurant/' . $restaurant->hash . '/favicon-16x16.png') }}">
    @endif

    @if (File::exists(public_path('user-uploads/favicons/restaurant/' . $restaurant->hash . '/favicon-32x32.png')))
    <link rel="icon" type="image/png" sizes="32x32"
            href="{{ asset('user-uploads/favicons/restaurant/' . $restaurant->hash . '/favicon-32x32.png') }}">
    @endif

    @if (File::exists(public_path('user-uploads/favicons/restaurant/' . $restaurant->hash . '/favicon.ico')))
    <link rel="shortcut icon"
            href="{{ asset('user-uploads/favicons/restaurant/' . $restaurant->hash . '/favicon.ico') }}">
    @endif

    @if (File::exists(public_path('user-uploads/favicons/restaurant/' . $restaurant->hash . '/site.webmanifest')))
    {{-- <link rel="manifest"
            href="{{ asset('user-uploads/favicons/restaurant/' . $restaurant->hash . '/site.webmanifest') }}"> --}}
    @endif
